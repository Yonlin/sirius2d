        ...
        /** @lends demo.Main.prototype */
        {
           ...
           _handleOverallProgress : function(e)
            ...
            _init:function()
            {
                ...
                //创建一个游戏场景,元素（quad）个数为10
                //create game scene with 10 elements（quads）
                var scene=new ss2d.Scene(texture,10);
                ...
                for(var i=0;i<10;i++)
                {
                    ...
                    //设置坐标
                    //set pos
                    quad.setX(ss2d.Stage2D.stageWidth/2*Math.random());
                    quad.setY(ss2d.Stage2D.stageHeight/2*Math.random());
            ...
            onEnterFrameHandler : function(e)
            {
                ...
                {
                    this.quadList[i].setX(this.quadList[i].getX()+Math.cos(this._time)*1);
                    this.quadList[i].setY(this.quadList[i].getY()+Math.sin(this._time)*1);
                }
            },
