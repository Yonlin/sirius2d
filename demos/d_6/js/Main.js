        ...
        /** @lends demo.Main.prototype */
        {
           ...
           _handleOverallProgress : function(e)
            ...
            _init:function()
            {
                ...
                //创建灯光着色器
                //create shaderlight
                this._shaderLight= new ss2d.ShaderLight();

                //设置影片剪辑着色器
                //set shaderlight
                mc.setShader(this._shaderLight);
            ...
            onEnterFrameHandler : function(e)
            {
                //设置灯光的位置
                //set shaderlight pos
                this._shaderLight.lightX=0.5-(ss2d.Stage2D.stageWidth/2-ss2d.Stage2D.mouseX)/600.0;
                this._shaderLight.lightY=-0.5+(ss2d.Stage2D.stageHeight/2-ss2d.Stage2D.mouseY)/400.0;
