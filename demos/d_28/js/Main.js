        ...
        /** @lends demo.Main.prototype */
        {
           ...
           _handleOverallProgress : function(e)
            ...
            _init:function()
            {
                ...
                //创建场景
                //create game scene
                var quadlist=new ss2d.Scene(new ss2d.Texture(demo.Main.assets.getResult("car.jpg"),textureStyle));
                ...
                //设置quad的缩放比
                //set quad scaleY
                this.car.setScaleY(-1);

                //设置quad的Y坐标
                //set quad posY
                this.car.setY(this.car.getHeight());
            ...
            {
                this.time+=1;
                this.car.setTileXOffset(this.time);
                this.car.setTileYOffset(this.time);
            }
