        ...
        /** @lends demo.Main.prototype */
        {
           ...
           _handleOverallProgress : function(e)
            ...
            _init:function()
            {
                ...
                //居中显示
                //align center
                this.car.setCenter(true);

                //设置quad位置
                //set quad pos
                this.car.setX(ss2d.Stage2D.stageWidth/2);
                this.car.setY(ss2d.Stage2D.stageHeight/2);
                ...
                //设置顶点位置偏移量
                //vertex offset
                this.car.setIndexVertex(0,-1.3,-1);
                this.car.setIndexVertex(1,-.7,1);
                this.car.setIndexVertex(2,1.3,-1);
                this.car.setIndexVertex(3, .7,1);
