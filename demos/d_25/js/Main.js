        ...
        /** @lends demo.Main.prototype */
        {
           ...
           _handleOverallProgress : function(e)
            ...
            _init:function()
            {
                //创建影片剪辑
                //create movie clip
                var carMovieClip=new ss2d.MovieClip(new ss2d.Texture(demo.Main.assets.getResult("mask.png")));
                ...
                //设置混色模式为遮掩
                //set blend mode as BLEND_MASK
                machineMovieClip.blend(ss2d.Blend.BLEND_MASK);
